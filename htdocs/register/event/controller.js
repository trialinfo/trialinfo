...
var eventController = [
  ...
  function ($routeParams, $scope, $cookies, $window, $timeout, $http, $anchorScroll, event, riders, suggestions) {
	...
	if ($scope.age_year) {
	  ...
	  if ($scope.age_year >= 45) {
	    if (rider.class == 5 || rider.class == 6)
	      ...
	      if (rider.class == 5 || rider.class == 7)
		rider.class = 6;
	  } else {
	    if (rider.class == 6 || rider.class == 7)
	      rider.class = 5;
	  }
	}
	...
	disable_class(5, $scope.age_year && $scope.age_year >= 12);
	disable_class(6, $scope.age_year && ($scope.age_year < 12 || $scope.age_year >= 45));
	disable_class(7, $scope.age_year && $scope.age_year < 45);
