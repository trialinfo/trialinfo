...
var einstellungenController = [
  '$scope', '$http', '$timeout', '$location', 'veranstaltung', 'veranstaltungen',
  function ($scope, $http, $timeout, $location, veranstaltung, veranstaltungen) {
